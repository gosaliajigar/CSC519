 ...
 */
package com.example.android.weather.app.test;
...
public class TestProvider extends AndroidTestCase {
    ...
    // Since we want each com.example.android.weather.app.test to start with a clean slate, run deleteAllRecords
    // in setUp (called by the com.example.android.weather.app.test runner before each com.example.android.weather.app.test).
    public void setUp() {
        deleteAllRecords();
    }
    ...
    public void testGetType() {
        // content://com.example.android.weather.app/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.weather.app/weather
        assertEquals(WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.example.android.weather.app/weather/94074
        ...
        // content://com.example.android.weather.app/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.example.android.weather.app/weather
        assertEquals(WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.example.android.weather.app/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.weather.app/location
        assertEquals(LocationEntry.CONTENT_TYPE, type);

        // content://com.example.android.weather.app/location/1
        type = mContext.getContentResolver().getType(LocationEntry.buildLocationUri(1L));
        // vnd.android.cursor.item/com.example.android.weather.app/location
    ...
    // to use this in our app, but in a com.example.android.weather.app.test it's fine to assume a higher target.
