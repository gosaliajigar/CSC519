...
public class InventoryProvider extends ContentProvider {
    ...
    public static final String LOG_TAG = InventoryActivity.APP_TAG;
    ...
    private Uri insertItem(Uri uri, ContentValues values) {
        ...
        Integer quantity = values.getAsInteger(InventoryContract.InventoryEntry.COLUMN_ITEM_QUANT);
    ...
    private int updateItems(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(InventoryContract.InventoryEntry.COLUMN_ITEM_QUANT)) {
            Integer quantity = values.getAsInteger(InventoryContract.InventoryEntry.COLUMN_ITEM_QUANT);
            if (quantity != null && quantity < 0) {
                throw new IllegalArgumentException("Item requires valid quantity");
            }
